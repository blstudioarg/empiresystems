                        ...
                        <ul class="navbar-nav header-right">
								...
								<li class="nav-item">
									<a class="nav-link" href="javascript:void(0);" id="asistente-toggle" title="Asistente IA" aria-label="Abrir asistente IA">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
											stroke="black" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
							...
							<li class="nav-item dropdown notification_dropdown">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
										<path d="M12.5 12.5C14.9853 12.5 17 10.4853 17 8C17 5.51472 14.9853 3.5 12.5 3.5C10.0147 3.5 8 5.51472 8 8C8 10.4853 10.0147 12.5 12.5 12.5Z" fill="black"/>
										<path d="M12.5 14.75C7.94365 14.75 4.25 17.3505 4.25 20.5625C4.25 20.9767 4.58579 21.3125 5 21.3125H20C20.4142 21.3125 20.75 20.9767 20.75 20.5625C20.75 17.3505 17.0563 14.75 12.5 14.75Z" fill="black"/>
									</svg>
								</a>
									<div class="dropdown-menu dropdown-menu-end">
