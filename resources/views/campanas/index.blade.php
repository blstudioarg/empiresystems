					...
					<div class="card same-card">
						<div class="card-body">
							<div class="d-flex justify-content-between align-items-center">
								...
								<div>
									<x-lordicon icon="wired-outline-1027-megaphone-media-hover-pinch" size="45" trigger="hover" target=".card" />
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body">
							<div class="d-flex justify-content-between align-items-center">
								<div>
									...
									<h4 class="mb-0" data-metric="enviados">0</h4>
								</div>
								<div>
...
@push('scripts')
	...
	<script src="@assetv('js/plugins-init/campanas-datatable.init.js')"></script>
@endpush
