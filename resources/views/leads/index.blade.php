...
@push('scripts')
	...
	<script src="@assetv('js/plugins-init/leads-datatable.init.js')"></script>
	<script src="@assetv('js/plugins-init/leads-modal.init.js')"></script>
	<script src="@assetv('js/plugins-init/leads-ficha.init.js')"></script>
