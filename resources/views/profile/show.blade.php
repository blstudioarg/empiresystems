	...
	<div class="content-body">
		<div class="container-fluid">
			<div class="card profile-overview">
				...
				{{-- En mobile la card apila (avatar arriba, datos abajo) y todo va centrado; desde
					lg vuelve a la fila avatar + datos alineados a la izquierda. --}}
				<div class="card-body d-lg-flex align-items-start text-center text-lg-start">
					{{-- Avatar + estado decorativo --}}
					<div class="clearfix">
						<div class="d-inline-block position-relative me-sm-4 me-3 mb-3 mb-lg-0">
							<x-avatar-editable class="profile-avatar-editor">
								@if ($user->estado)
									<span
										class="fa fa-circle border border-3 border-white position-absolute bottom-0 start-0 rounded-circle
										@class([
					...
					<div class="clearfix flex-grow-1">
						<div class="d-flex align-items-center flex-wrap mb-1 justify-content-center justify-content-lg-start">
						...
						<ul class="d-flex flex-wrap fs-6 align-items-center mb-0 justify-content-center justify-content-lg-start">
